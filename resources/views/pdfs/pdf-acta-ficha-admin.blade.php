...
<div class="header">
    ...
    <h4>FICHA DE EVALUACIÓN ADMINISTRATIVA</h4>
</div>
...
<div class="evaluation-result">
    EL RESULTADO DE LA EVALUACIÓN TÉCNICA ES: @if($applicationsData->calification_admin == 1)
        PRECALIFICADO
    @else
        NO PRECALIFICADO
    @endif
...
@if(!empty($dataApplication))
    @foreach ($dataApplication as $tipo => $empresas)
