...
<form>
    <div class="mb-3">
        ...
        <input wire:model="cod_medicamento" type="text"
               class="form-control @error('cod_medicamento') is-invalid @enderror">
    ...
    <div class="mb-3">
        ...
        <select name="id_familia_producto" id="id_familia_producto" class="form-control"
                wire:model.live="FamProductoId">
    ...
    <div class="mb-3">
        ...
        <select name="id_grupo_requerimiento" id="id_grupo_requerimiento" class="form-control"
                wire:model="GrupoRequisitoId">
