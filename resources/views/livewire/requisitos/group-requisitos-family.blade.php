@section('title')
    @lang('NCMEDCAD | Grupos de familia de productos')
@endsection
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-md-3">
                        {{--                        <div class="mb-3">--}}
                        {{--                            <input type="text" class="form-control rounded bg-light border-0" wire:model="nameFamily"--}}
                        {{--                                   id="nameFamily" placeholder="Escribe el nombre de la familia de productos">--}}
                        {{--                            @error('nameFamily')--}}
                        ...
                        @if(!empty($data))
                            ...
                            @foreach($data as $permisoitems)
                                <tr>
                                    ...
                                    <td>{{ $permisoitems->familia_producto }}</td>
    ...
    @include('livewire.requisitos.formaddgroup')
    @include('livewire.requisitos.formdetailgroup')
...
@section('script')
    ...
    <script>
        ...
        function seeViewDetail(id) {
            Livewire.dispatch('seeViewDetailRequisitos', {idFamily: id})
        }
        ...
        function confirm(id) {
            Swal.fire({
                ...
                if (result.value) {
                    Livewire.dispatch('deleteGroupRequisitos', {postId: id})
                    swal.close();
                }
            });
